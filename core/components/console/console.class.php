...
class ConsoleManagerController extends modExtraManagerController
{
    ...
    function __construct(modX &$modx, $config = array())
    {
        ...
        $this->config['namespace_assets_path'] = $modx->call(
            modNamespace::class,
            'translatePath',
            array(&$modx, $this->config['namespace_assets_path'])
        );
        #manager url still called "assets_url" for safe install
        $this->config['manager_url'] = $modx->getOption(
            'console.manager_url',
            null,
            $modx->getOption('manager_url').'components/console/'
        );
